  ...
  module XMLSchema
    ...
    class Element < Info
      ...
      def parse_element(element)
        puts "\n\nElement#parse_element: element=#{element}"
        case element
        when SimpleTypeName
        ...
        when ComplexTypeName
          ...
          puts "Was complex type @local_complextype=#{@local_complextype}"
          @local_complextype
        when UniqueName
      ...
      def parse_attr(attr, value)
        puts "Element#parse_attr: attr=#{attr} value=#{value}"
        case attr
        when NameAttrName
      ...
      def to_s
        ...
        str += "  Form: #{form}\n" if form
        str += "  Type: #{type}\n" if type
        str += "  Local Simple Type: #{local_simpletype}\n" if local_simpletype
        str += "  Local Complex Type: #{local_complextype}\n" if local_complextype
        str += "  Constraint: #{constraint}\n" if constraint
        str += "  Max Occurs: #{maxoccurs}\n" if maxoccurs
        str += "  Min Occurs: #{minoccurs}\n" if minoccurs
        str += "  Nillable: #{nillable}\n" if nillable
        str += "  Default: #{default}\n" if default
        str += "  Abstract: #{abstract}\n" if abstract
        str += "  Ref: #{ref}\n" if ref
        str += "  Ref Element: #{refelement}\n" if refelement
        str
      end
